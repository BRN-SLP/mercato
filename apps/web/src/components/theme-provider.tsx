 ...
 *   - Centralizing configuration (attribute, defaultTheme, storage key)
 *     here means a future swap to a different theming library is one
 *     file edit, not a hunt across the codebase.
 *
 * Defaults explained:
 ...
 *   - `enableSystem` — keeps the "follow system" option selectable so
 *     users can return to it after explicitly picking one.
